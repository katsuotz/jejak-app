...
{#if $needRefresh}
  <div
    class="fixed bottom-16 left-0 right-0 z-[100] flex justify-center px-4 pb-2 animate-in slide-in-from-bottom">
    <div
      class="flex w-full max-w-sm items-center gap-3 rounded-xl border border-border bg-card p-3 shadow-lg">
